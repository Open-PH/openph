    ...
    def __post_init__(self) -> None:
        ...
        if not isinstance(self.extends_classes, set):
            self.extends_classes = (
                set(self.extends_classes) if self.extends_classes else set()
            )
...
class AttributeRegistry:
        ...
        for ep in eps:
            try:
                ...
                attribute_info = AttributeInfo(
                    ...
                    if attribute_class.extends_classes
                    else set(),
                    description=attribute_class.attribute_description
                    if hasattr(attribute_class, "attribute_description")
                    else "",
    ...
    def _validate_attribute_protocol(self, attribute_class: Type) -> None:
        ...
        missing_attrs = [
            attr for attr in required_attrs if not hasattr(attribute_class, attr)
        ]
    ...
    def has_attributes_for_class(self, class_name: str) -> bool:
        ...
        return (
            class_name in self._class_index and len(self._class_index[class_name]) > 0
        )
